...
import com.jiangxufa.server.BookController;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void bindService() {
        ...
        intent.setPackage("com.jiangxufa.demoaidl");
        intent.setAction("com.jiangxufa.server.action");
